    ...
    <div className="flex w-full flex-col">
      ...
      <div className="max-w-3xl mx-auto antialiased pt-4 relative ">
        ...
        <p className="px-4 md:px-0">
          ...
          using NestJS, which provided a RESTful API's for the frontend applications to interact with. The backend also utilized the Google Calendar
          API to create and manage events on the user's calendar. The desktop application was built using React with Electron while the mobile
          application uses React Native, allowing for a seamless user experience across all platforms. Unit testing was also setup using Jest to
