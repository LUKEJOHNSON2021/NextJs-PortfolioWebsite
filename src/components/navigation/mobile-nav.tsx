...
export default function MobileMenu() {
  ...
  return (
    <>
      ...
      >
        <IoMenu className="text-zinc-900 dark:text-white text-black text-3xl" />
      </button>
        ...
        {isMenuOpen && (
          <>
            ...
            >
              <Link
                href="/projects"
                className="text-xl text-zinc-700 hover:text-zinc-900 dark:text-white dark:hover:text-zinc-300 font-medium"
