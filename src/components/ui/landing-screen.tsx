...
const LandingScreen = () => {
  return (
    <div className="min-h-screen w-3/4 max-w-[1414px] flex flex-col lg:px-16">
      <div className="h-[13%] flex"></div>
      <div>
        <LandingText />
      </div>
      <AnimatedLinks>
        ...
        <Link
          ...
          className="border-zinc-900 dark:border-zinc-200 border-2 text-zinc-900 dark:text-zinc-200 flex flex-row items-center rounded-full p-6 transition-all duration-300 hover:border-zinc-700 hover:dark:border-zinc-300 hover:scale-105"
          target="_blank"
        >
