...
const GameHub = () => (
  <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl justify-between overflow:hidden">
...
const items = [
  {
    ...
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl justify-between overflow:hidden">
        <img src="/Headers/Rcadia.png" className="w-full h-full object-contain" />
      </div>
    ),
  ...
  },
  {
    ...
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl justify-between overflow:hidden">
        <img src="/Headers/Sync-Up-Header.png" className="w-full h-full object-contain" />
      </div>
    ),
  ...
  },
  {
    ...
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl justify-between overflow:hidden">
        <img src="/Headers/Portfolio.png" className="w-full h-full object-contain" />
      </div>
    ),
  ...
  },
  {
    ...
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl justify-between overflow:hidden">
        <img src="/Headers/VoiceAssistant.png" className="w-full h-full object-contain" />
      </div>
    ),
  ...
  },
  {
    ...
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl justify-between overflow:hidden">
        <img src="/Headers/OrganizeTimeMobile.png" className="w-full h-full object-contain" />
      </div>
    ),
